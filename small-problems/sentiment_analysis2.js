...
function sentiment(text) {
  var positive = text.match(positiveRegex).map(toLowerCaseWord);
  var negative = text.match(negativeRegex).map(toLowerCaseWord);

  var overallSentiment = (positive.length > negative.length ? 'positive' : 'negative');
