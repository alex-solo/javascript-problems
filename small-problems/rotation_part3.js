...
ALGORITHM:
- convert number to string
- iterate through numbers starting from string length down to 2 (n)
- isolate number and n at each iteration and use rotateRightmostDigits function to assign result to temp number
-  
-    num = rotateRightmostDigits(parseInt(num, 10), i)
...
function rotateRightmostDigits(number, n) {
  ...
  var firstPart = numberString.substr(0, numberString.length - n);
